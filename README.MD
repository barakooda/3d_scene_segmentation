...
## Example Output
<p align="center">
  <img src="./docs/images/rgb.webp" alt="RGB Image" width="30%" />
  <img src="./docs/images/segmentation.png" alt="Segmentation Image" width="30%" />
</p>
...
- **Minimal Material Optimiztion**: The number of materials needed for segmentation is minimal and usually ends up with only two.
